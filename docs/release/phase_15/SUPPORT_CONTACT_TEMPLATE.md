# Comprezza Support Contact Template
...
- **Escalation owner:** `[REPLACE_WITH_ESCALATION_OWNER]`
...
- [ ] Public URL resolves over HTTPS without login.
- [ ] Auto-reply confirms receipt and privacy-safe attachment guidance.
- [ ] Support contact matches Play Console and store listing.
